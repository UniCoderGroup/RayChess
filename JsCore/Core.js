...
(function (RayChess) {
    ...
    RayChess.GetRelativePlayer = GetRelativePlayer;
    ...
    RayChess.OppositeDirection = OppositeDirection;
    class Coord {
        constructor(X = -1, Y = -1) {
            this.x = X;
            this.y = Y;
    ...
    RayChess.Coord = Coord;
    RayChess.InvalidCoord = { x: -1, y: -1 };
    RayChess.WriteLog = console.log;
    function GetSurroundingCoord(c, d) {
        switch (d) {
            ...
            case 8 /* Bottom */:
                return new Coord(c.x, c.y + 1);
            default:
                return RayChess.InvalidCoord;
        }
    }
    RayChess.GetSurroundingCoord = GetSurroundingCoord;
    //Base end
    //////////////////////////////////////////////////
    //Grid begin
    let TypeOfMirror;
    ...
    })(TypeOfMirror = RayChess.TypeOfMirror || (RayChess.TypeOfMirror = {}));
    ...
    RayChess.TypeOfMirror2Direction = TypeOfMirror2Direction;
    ...
    RayChess.Direction2TypeOfMirror = Direction2TypeOfMirror;
    let TypeOfCross;
    ...
    })(TypeOfCross = RayChess.TypeOfCross || (RayChess.TypeOfCross = {}));
    let TypeOfGrid;
    (function (TypeOfGrid) {
        TypeOfGrid[TypeOfGrid["Home"] = 0] = "Home";
        TypeOfGrid[TypeOfGrid["Normal"] = 1] = "Normal";
    })(TypeOfGrid = RayChess.TypeOfGrid || (RayChess.TypeOfGrid = {}));
    ...
    RayChess.BorderMirrorType = BorderMirrorType;
    ...
    RayChess.CrossMirrorType = CrossMirrorType;
    class MirrorType {
    }
    RayChess.MirrorType = MirrorType;
    class Grid {
        get Type() { return this.type; }
    }
    RayChess.Grid = Grid;
    ...
    RayChess.GridNormal = GridNormal;
    //Grid end
    //////////////////////////////////////////////////
    //Map begin
    class Map {
        ...
        CreateHome(x, y, whose) {
            if (this.GetHomeCoord(whose) != RayChess.InvalidCoord) {
